...
namespace DDD.Application.Api.Controllers
{
    ...
    public class MatriculaController : ControllerBase
    {
        ...
        public ActionResult<Matricula> CreateMatricula(int idAluno, int idSeqCurso)
        {
            Matricula matriculaIdSaved = _matriculaRepository.InsertMatricula(idAluno, idSeqCurso);
        ...
        public ActionResult Delete([FromBody] Matricula matricula)
        {
            try
            {
                ...
                return Ok("Matricula Removido com sucesso!");
            }
            catch (Exception ex)
            {
                return BadRequest(ex.Message);
